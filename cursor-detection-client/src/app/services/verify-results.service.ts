...
export class VerifyResultsService {
    ...
    post( verifiedResultsCollectionName: string, body: any) {
        return this.http.post(this.url, {results: body, verifiedResultsCollectionName: verifiedResultsCollectionName},
            {responseType: 'text'});
    }
}
